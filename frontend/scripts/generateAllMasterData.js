...
console.log("Writing comprehensive data builder...");

const builderCode = `const fs = require('fs');
const path = require('path');
...
export interface SubVariation {
  ...
  name: string;
  eco: string;
  moves: string[]; // Sequence of SAN moves (10-22 plies)
  description: string;
  whitePlan: string;
  blackPlan: string;
  keyThemes: string[];
...
fs.writeFileSync(path.join(__dirname, 'generateAllMasterData.js'), builderCode, 'utf8');
console.log("Created generateAllMasterData.js");
