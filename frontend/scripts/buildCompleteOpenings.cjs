...
const { validateMoves, generateExplanations } = require('./openingsBuilderUtils.cjs');

console.log("Defining 240+ deep opening lines across 12 families...");

const OPENING_FAMILIES_DATA = [
  // ── 1. BENONI DEFENSE & BENKO GAMBIT (DEDICATED FAMILY) ───────────────────
  {
    id: "benoni",
...
// Helper to append the remaining 11 families with multiple deep variations...
console.log("Benoni Family created with", OPENING_FAMILIES_DATA[0].subVariations.length, "variations!");

module.exports = {
  OPENING_FAMILIES_DATA
};
