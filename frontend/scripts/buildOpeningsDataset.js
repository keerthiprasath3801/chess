...
// We will construct the master data generator.
// Let's create `scripts/buildOpeningsDataset.js`.

const buildScriptContent = `
const fs = require('fs');
const path = require('path');

console.log("Starting build of openings master dataset...");
...
console.log("Compiling master data output...");
`;

console.log("Ready to execute generator script.");
